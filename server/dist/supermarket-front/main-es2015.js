...
let CartComponent = class CartComponent {
    ...
    ngOnChanges(changes) {
        const cartProducts = changes.cartProducts;
...
let EditSidebarComponent = class EditSidebarComponent {
...
EditSidebarComponent.ctorParameters = () => [
    { type: _services_backend_api_service__WEBPACK_IMPORTED_MODULE_2__["BackendApiService"] },
...
let OrderCompleteComponent = class OrderCompleteComponent {
...
OrderCompleteComponent.ctorParameters = () => [
...
let ProductsComponent = class ProductsComponent {
    ...
    ngOnChanges(changes) {
        const products = changes.myProducts;
...
BackendApiService.ctorParameters = () => [
